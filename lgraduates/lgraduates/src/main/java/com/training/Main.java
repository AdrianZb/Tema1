...
public class Main {
    ...
    public static void main(String[] args) throws IllegalAccessException, InstantiationException {
        ...
        Class<? extends TestEx> clazz = TestExample.class;
        getAuthorInfo(clazz);
        prioritizeExecution(clazz);
    ...
    private static void executeMethods(Class clazz) {
        for (Method method : clazz.getDeclaredMethods()) {
            ...
            if (method.isAnnotationPresent(Test.class)) {
                ...
                Annotation skipAnnotation = method.getAnnotation(Skip.class);
    ...
    private static void getAuthorInfo(Class<? extends TestEx> clazz) {
    ...
    private static void prioritizeExecution(Class<? extends TestEx> clatz) {
        if (!clatz.isAnnotationPresent(Skip.class)) {
